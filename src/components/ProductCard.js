...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link to={`/product/${product.id}`} className="border mt-10 rounded-xl  bg-slate-100 p-4 hover:box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1); hover:scale-110 transition-transform ease-in-out duration-300">
